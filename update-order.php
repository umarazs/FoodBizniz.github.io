                ...
                <tr>
                    ...
                    <td>
                        <select name="status">
                            ...
                            <option <?php if($status=="Preparing Food"){echo "selected";}?>value="Preparing Food">Preparing Food</option>
                            <option <?php if($status=="Serving"){echo "selected";}?>value="Serving">Serving</option>
